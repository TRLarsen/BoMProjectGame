...
# CREDIT: https://www.pygame.org/pcr/text_rect/index.php - David Clark
# This is a module for rendering text in a pygame Rect. 
# The only change made was updating exception syntax.
